...
Follow this workflow to create a new asset under the `03_MVP_Demo` Modular Architecture.
...
## 2. Scaffold Scripts
Create the generator script in `03_MVP_Demo/_Pipeline/generators/`.

```bash
# Example Name: gen_S03_alice_voice.py
touch 03_MVP_Demo/_Pipeline/generators/gen_S[MODULE]_[NAME].py
```
...
```bash
python 03_MVP_Demo/_Pipeline/generators/gen_S[MODULE]_[NAME].py
ls -l 03_MVP_Demo/_Library/S[MODULE]_[NAME_GROUP]/
```

## 4. Documentation
Update `03_MVP_Demo/Asset_Production_Guide.md` to include the new file in the Manifest table.
