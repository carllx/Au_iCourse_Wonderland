...
def main():
    ...
    save_wav(os.path.join(OUTPUT_DIR, "contrast_IR_small_closet.wav"), ir_small, SAMPLE_RATE)
    ...
    save_wav(os.path.join(OUTPUT_DIR, "contrast_IR_large_hall.wav"), ir_large, SAMPLE_RATE)

    # Vocal processing removed to keep this script focused on IR generation only.
    print("Done.")
