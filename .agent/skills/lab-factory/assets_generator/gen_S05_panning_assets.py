...
SOURCE_VOCAL = os.path.join(PROJECT_ROOT, "01_MVP_Demo/_Library/S0X_Shared/asset_S0X_dry_voice_clean.wav")
OUTPUT_DIR = os.path.join(PROJECT_ROOT, "_Library/S05_Position")
BPM = 100
SAMPLE_RATE = 44100
...
def main():
    ...
    save_wav(os.path.join(OUTPUT_DIR, "asset_S05_opponent.wav"), vocal_processed, SAMPLE_RATE)
    ...
    save_wav(os.path.join(OUTPUT_DIR, "asset_S05_heartbeat_visceral.wav"), track_heartbeat, SAMPLE_RATE)
    ...
    save_wav(os.path.join(OUTPUT_DIR, "asset_S05_threat_L.wav"), pressure, SAMPLE_RATE)
    ...
    save_wav(os.path.join(OUTPUT_DIR, "asset_S05_threat_R.wav"), anxiety, SAMPLE_RATE)
