...
首先是 **Noise Reduction (降噪比例)**。我把它推到 **75%**。
...
我们不需要把噪音“消音”到外太空（100dB），我们只需要把它推回深夜（30dB）。
...
**[AUDIO]**
(严肃纠偏，技术解密)
现在，请盯着这张图谱。很多人以为红红绿绿的只是好看的背景板，不，这是战场地图。
...
**[AUDIO]**
看见这条**蓝色曲线**了吗？它是你手里的**判决笔**。
你把蓝线往上拉，绿色警戒线就会升高——这意味着杀戮更严厉。
你把蓝线往下拉，绿色警戒线就会降低——这意味着更宽容。

对于爱丽丝的心跳，我要做一个 **“左低右高”** 的调节：

> **[PACING]**
> *   语速放慢，配合鼠标动作。

**左边（低频）——我要拉低蓝线 (Pull Down)。**
为什么？因为心跳这种微弱的低频信号，很容易和底噪混在一起。
如果这里的门槛太高，心跳就会被当成噪音误杀。
所以，我把门槛降下来，给心跳留出一条生路。

**右边（高频）——我保持不动，甚至可以抬高 (Push Up)。**
因为这里主要是嘶嘶的电流声，没有任何有价值的生命信号。
我们可以放心大胆地提高门槛，把所有的尘埃都死死按在水面以下。
...
“不要像数学家那样精确地切割每一个频率点，要像艺术家的笔触一样，把伤口的边缘晕染开。”

简单说，就是把刚刚切开的锯齿状伤口，打磨得圆润一点。
这点微小的模糊，能让最后一点“电子味”消失在空气中。
